 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".slider-values__slider")) new swiper_core_Swiper(".slider-values__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                ...
                speed: 800,
                navigation: {
                    prevEl: ".slider-values__button-prev",
                    nextEl: ".slider-values__button-next"
                },
                on: {}
            });
            if (document.querySelector(".supervisory-page__slider")) new swiper_core_Swiper(".supervisory-page__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                ...
                speed: 800,
                navigation: {
                    prevEl: ".supervisory-page__button-prev",
                    nextEl: ".supervisory-page__button-next"
                },
                breakpoints: {
                    320: {
                        spaceBetween: 10
            ...
            if (document.querySelector(".content-location__slider")) new swiper_core_Swiper(".content-location__slider", {
                ...
                speed: 800,
                pagination: {
                    el: ".content-location__swiper-pagination",
                    clickable: true,
                    dynamicBullets: true
                },
                navigation: {
        ...
        function windowLoaded() {
            ...
            function updateDataShowmoreContent() {
                const contentBlock = document.querySelector(".specialists-page__block [data-showmore-content]");
                if (!contentBlock) return;
                const screenWindow = window.innerWidth;
                if (screenWindow < 689) contentBlock.setAttribute("data-showmore-content", "6"); else if (screenWindow < 1089) contentBlock.setAttribute("data-showmore-content", "3"); else contentBlock.setAttribute("data-showmore-content", "2");
            }
            updateDataShowmoreContent();
            function updateBlogPageDataShowmoreContent() {
                const blogContentBlock = document.querySelector(".blog-page__block [data-showmore-content]");
                if (!blogContentBlock) return;
                const screenWindow = window.innerWidth;
                if (screenWindow < 689) blogContentBlock.setAttribute("data-showmore-content", "3"); else blogContentBlock.setAttribute("data-showmore-content", "1");
            }
            updateBlogPageDataShowmoreContent();
